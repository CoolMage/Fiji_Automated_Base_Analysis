...
class FijiConfig:
    ...
    def get_fiji_paths() -> List[str]:
        ...
        return [
            ...
            "/opt/Fiji.app/fiji-linux64",
            "/opt/Fiji.app/fiji",
            "/opt/fiji/ImageJ-linux64",
            "/opt/fiji/fiji-linux64",
            "/opt/fiji/fiji",
            "/usr/local/Fiji.app/ImageJ-linux64",
            "/usr/local/Fiji.app/fiji-linux64",
            "/usr/local/Fiji.app/fiji",
            "/usr/local/fiji/ImageJ-linux64",
            "/usr/local/fiji/fiji-linux64",
            "/usr/local/fiji/fiji",
            "/usr/local/bin/fiji",
            os.path.expanduser("~/fiji/ImageJ-linux64"),
            os.path.expanduser("~/fiji/fiji-linux64"),
            os.path.expanduser("~/fiji/fiji"),
            os.path.expanduser("~/Fiji.app/ImageJ-linux64"),
            os.path.expanduser("~/Fiji.app/fiji-linux64"),
            os.path.expanduser("~/Fiji.app/fiji"),
            ...
            os.path.expanduser("~/Desktop/Fiji.app/fiji"),
            os.path.expanduser("~/Downloads/Fiji.app/ImageJ-linux64"),
            os.path.expanduser("~/Downloads/Fiji.app/fiji-linux64"),
            os.path.expanduser("~/Downloads/Fiji.app/fiji"),
            os.path.expanduser("~/Downloads/Fiji*.AppImage"),
            os.path.expanduser("~/Downloads/ImageJ*.AppImage"),
            os.path.expanduser("~/.local/bin/fiji"),
            os.path.expanduser("~/.local/bin/imagej"),
            "/snap/bin/fiji",
            "/snap/bin/imagej",
            "/usr/bin/imagej",
