...
MACROS_LIB.add_from_file(
    "measure_iba1_cd206_cd86_3d_colocalization",
    "iba1_cd206_cd86_3d_colocalization_macro.ijm",
    aliases=("iba1_cd206_cd86_colocalization",),
    profile=MacroGuiProfile(
        apply_roi_templates=True,
        save_processed_images=True,
        save_measurement_csv=True,
        generate_measurement_summary=True,
        processed_suffix="colocalization",
        measurements_folder="Colocalization_Measurements",
        processed_folder="Colocalization_QC",
        measurement_prefix="iba1_cd206_cd86_colocalization_summary",
        note=(
            "Quantifies 3D Iba1/CD206 and Iba1/CD86 voxel overlap, "
            "triple-positive signal, and local marker enrichment; "
            "pilot thresholds must be calibrated from controls."
        ),
    ),
)
